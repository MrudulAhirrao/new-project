...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.min.css">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Afacad:wght@400;500;600;700&family=Anek+Bangla:wght@600&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../assets/css/coun.css">
</head>
...
<section class="package-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <h2 style="font-size: 48px; font-weight: 600; color: #002445; margin-bottom: 20px;">Counselling Package</h2>
                    <p style="font-size: 18px; color: #02386a; line-height: 33px; margin-bottom: 30px;">
                        We offer accurate, thorough, and up-to-date information about undergraduate medical courses like MBBS, BDS, BAMS, BNYS, BHMS and BUMS. Our services include comprehensive guidance on the entire counseling procedure and admission process. Many students with good NEET scores miss out on MBBS and BDS admissions simply because they lack knowledge about the counseling and admission process.
                    </p>
                    <a href="https://v4edusolution.com/packages.php" target="_blank" class="package-btn">
                        Packages
                        <span>→</span>
                    </a>
                </div>
                <div class="col-lg-6 text-center">
                    <img src="../assets/img/pakage-right-shap.png" alt="Package" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </section>
  ...
  <section class="services-section" >
        <div class="container">
            ...
            <p class="text-center mb-5" style="font-size: 18px; line-height: 30px; max-width: 1000px; margin: 0 auto; color: #dadcdcff;">
                We provide guidance to help you understand the NEET UG & PG admission process 2025, ensuring the best possible medical seat will allot to you. From counselling registration to document verification, our dedicated counselors are here to support you every step in NEET counselling 2025.
            </p>

            <div class="services-box">
                <h3 class="service-title">NEET Counselling Services 2025</h3>
                <div class="row">
                    <div class="col-lg-6">
    ...
    <section class="admission-services">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 mb-5 ">
                    <img src="../assets/img/win.png" alt="Admission Services" class="img-fluid rounded">
                </div>
                <div class="col-lg-6 d-md-flex align-items-center justify-content-center">
                    <div class="admission-box mb-4">
                        <h3 class="admission-title">NEET Admission Services 2025</h3>
                        <ul class="list-unstyled custom-checked-list">
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>Best MBBS Admission Guidance 2025</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>Best BDS Admission 2025 Guidance</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>Best BVSC Admission 2025 Guidance</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>Best BHMS Admission 2025 Guidance</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>Rajasthan State Counselling 2025 (UG & PG)</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>MBBS Admission (NRI Quota/ Management Quota/ Govt Seat/ General Seat)</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>MD/MS Admission (NRI Quota/ Management Quota/ Govt Seat/ General Seat)</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>Direct BVSC Admission 2025 (for eligible institutions)</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="counselling-services">
        <div class="container">
            <h2 class="text-center mb-3" style="font-size: 48px; font-weight: 600;">Who Can Take Our NEET Services 2025?</h2>
                ...
                <div class="row"  style="color: #333;">
                    <div class="col-lg-6">
                        <ul class="list-unstyled custom-checked-list">
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>NEET UG 2025 aspirants seeking MBBS/BDS/BAMS/BHMS/BSMS/BUMS/BVSC admissions</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>NEET PG 2025 aspirants targeting MD/MS/DNB seats</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>Students confused about AIQ v/s State Quota options</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>Parents looking for trusted counselling services 2025 for their ward</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>NEET Aspirants 2025 looking for minimum budget college 2025 options</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>Repeaters and droppers needing a strong admission plan</span>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
                        <ul class="list-unstyled custom-checked-list">
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>NEET Students looking for Lowest Budget MBBS Colleges</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>NEET Students looking for Fee negotiation in private medical colleges</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>NEET Students looking for all India and all State counsellings</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>NEET Students looking for services Registration to final admission help</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>NEET Students looking for Document verification and Reporting process</span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>NEET Students looking for NRI Quota MBBS admission</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <h2 class="contact-title">
                        Let's Get <span class="green">Connected</span>
                    </h2>
                    <p style="font-size: 18px; color: #02386a; line-height: 30px;">
                        If you're from Jaipur and planning for a successful career in medical education, we provide the best NEET counselling services 2025 in Jaipur (Rajasthan) through our online system. Don't leave your future to chance and Don't wait for last bell. Choose V4edusolution NEET counsellor Jaipur for the best NEET counseling services 2025 in Jaipur and 100% secure your seat in a top medical college with minimum budget.
                    </p>
                </div>
                <div class="col-lg-6">
    ...
    <section class="map-section">
        <div class="container">
            <h2 style="text-align: center; font-weight: 700; margin-bottom: 40px; color: #222; font-size: 48px;">Find Us Here</h2>
            <div class="map-wrapper">
                <div class="map-box">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3465.739356821016!2d75.76841329999999!3d26.8906013!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db5402370d04f%3A0x44a447d76ad414b2!2sV4EDU%20NEET%20UG%2FPG%20Counsellor!5e1!3m2!1sen!2sin!4v1759229398230!5m2!1sen!2sin"
                        width="100%" height="100%" style="border:0; border-radius: 15px;" allowfullscreen="" loading="lazy">
                    </iframe>
                </div>
                ...
                <div class="info-box-map">
                    ...
                    <p>
                        E-6 Hanuman Path, Shyam Nagar, New Sanganer Rd,<br>
                        opposite Pillar Number 94, Sodala,<br>
                        Jaipur, Rajasthan 302019<br>
                        +91-9799203537
                    </p>
                    <a href="https://maps.app.goo.gl/3dUo4dUBADPBUhuD7" target="_blank" class="view-map-btn">View on Map</a>
                </div>
            </div>
        </div>
    </section>
